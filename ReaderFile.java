     ...
     public static void Reader() {
          ...
          try {
               ...
               while (scanner.hasNextLine()) {
                    ...
                    if (mips.isDest(temp[0])) { // formata para cada caso, esse é para o primeiro registrador como
                                                // destino
                         ...
                         System.out.println("SGDFASDFAS");
                         instruction = new Instruction(temp[0], temp[3], temp[2], temp[1]); 
                    }
